    ...
    fun requestPermissionForReadExternalStorage(context: Context) {
        try {
            ActivityCompat.requestPermissions(
                ...
                AppConstant.READ_STORAGE_PERMISSION_REQUEST_CODE
            )
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    fun requestPermissionForWriteExternalStorage(context: Context) {
        try {
            ActivityCompat.requestPermissions(
                ...
                AppConstant.WRITE_EXTERNAL_STORAGE_REQUEST_CODE
            )
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    fun requestPermissionForCamera(context: Context) {
        try {
            ActivityCompat.requestPermissions(
                ...
                AppConstant.CAMERA_REQUEST_CODE
            )
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    fun requestPermissionForAccessFineLocation(context: Context) {
        try {
            ActivityCompat.requestPermissions(
                ...
                AppConstant.ACCESS_FINE_LOCATION_REQUEST_CODE
            )
        } catch (e: Exception) {
            e.printStackTrace()
        }
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ActivityCompat.requestPermissions(
                    ...
                    AppConstant.ACCESS_BACKGROUND_LOCATION_REQUEST_CODE
                )
            }
        } catch (e: Exception) {
            e.printStackTrace()
    ...
    fun requestPermissionForAccessCourseLocation(context: Context) {
        try {
            ActivityCompat.requestPermissions(
                ...
                AppConstant.ACCESS_COARSE_LOCATION_REQUEST_CODE
            )
        } catch (e: Exception) {
            e.printStackTrace()
        }
...
//        if (!checkPermissionForAccessBackgroundLocation(context)) return KeyFrame.ACCESS_BACKGROUND_LOCATION_REQUEST_CODE
        if (!checkPermissionForAccessCourseLocation(context)) return AppConstant.ACCESS_COARSE_LOCATION_REQUEST_CODE
        if (!checkPermissionForAccessFineLocation(context)) return AppConstant.ACCESS_FINE_LOCATION_REQUEST_CODE
        if (!checkPermissionForCamera(context)) return AppConstant.CAMERA_REQUEST_CODE
        if (!checkPermissionForReadExternalStorage(context)) return AppConstant.READ_STORAGE_PERMISSION_REQUEST_CODE
        if (!checkPermissionForWriteExternalStorage(context)) return AppConstant.WRITE_EXTERNAL_STORAGE_REQUEST_CODE
        return 0
    }
}